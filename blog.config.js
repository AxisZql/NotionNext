const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我喜欢Rust、C++和Go👾, Hi，我是一个干饭人🦤, 欢迎来到我的博客🎉', // 首页大图标语文字',
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 1600, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,facebook,twitter,telegram', // 分享的服務，按顺序显示,逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
    ...
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12488525787', //  对应歌单的 id
  ...
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.axiszql.cn/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "axiszql's learning note", // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
